...
class Sofort extends Ideal{
   ...
   public function get_default_title(){
      return __('Adyen - Sofort', 'integration-adyen-woocommerce');
   }
   ...
   public function get_default_description(){
      return sprintf(__('In order to support recurring payments with Sofort you have to enable SEPA Direct Debit first. %s', 'integration-adyen-woocommerce'), '<br/>'.$this->show_supported_country());
   }
