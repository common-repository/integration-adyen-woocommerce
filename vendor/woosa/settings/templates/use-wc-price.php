...
<tr>
   ...
   <td class="forminp">
      <label>
         ...
         <input type="checkbox" id="<?php echo esc_attr( $value['id'] ); ?>" name="<?php echo esc_attr( $value['id'] );?>" <?php checked($use_wc_price, 'yes');?> data-<?php echo PREFIX;?>-has-extra-field="<?php echo esc_attr( $value['id'] );?>" value="yes"> <?php _e('Yes', 'integration-adyen-woocommerce');?>
      </label>
      <p data-<?php echo PREFIX;?>-extra-field-<?php echo esc_attr( $value['id'] );?>="yes" style="<?php echo esc_attr( $display_field );?>">
         <label style="font-style:italic; font-size:12px;"><?php _e('Adjust the price (e.g. "10" for fixed amount or "10%" for percentage amount)', 'integration-adyen-woocommerce');?></label><br/>
